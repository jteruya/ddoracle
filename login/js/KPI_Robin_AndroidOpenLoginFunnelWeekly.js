...
androidopenloginfunnelweekly_options = {
  chart: {
    renderTo: 'androidopenloginfunnelweekly',
    type: 'area',
    // zoomType: 'x',
    height: 500,
    // width: 1000,
  ...
  title: {
    text: 'Android Open Bundle Login Funnel per Week'
  },
  subtitle: {
...
$.get('csv/KPI_Robin_AndroidOpenLoginFunnelWeekly.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      androidopenloginfunnelweekly_options.series.push(series)
      dummy = 1;
    }
...
androidopenloginfunnelweekly = new Highcharts.Chart(androidopenloginfunnelweekly_options);
