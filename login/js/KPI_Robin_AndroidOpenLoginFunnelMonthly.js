...
androidopenloginfunnelmonthly_options = {
  chart: {
    renderTo: 'androidopenloginfunnelmonthly',
    type: 'area',
    // zoomType: 'x',
    height: 500,
    // width: 1000,
  ...
  title: {
    text: 'Android Open Bundle Login Funnel per Month'
  },
  subtitle: {
...
$.get('csv/KPI_Robin_AndroidOpenLoginFunnelMonthly.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      androidopenloginfunnelmonthly_options.series.push(series)
      dummy = 1;
    }
...
androidopenloginfunnelmonthly = new Highcharts.Chart(androidopenloginfunnelmonthly_options);
