...
iosloginfunnelstartweekly_options = {
  chart: {
    renderTo: 'iosloginfunnelstartweekly',
    type: 'column',
    zoomType: 'x',
    height: 500,
    // width: 1000,
...
$.get('csv/KPI_Robin_iOSLoginFunnelWeekly.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      iosloginfunnelstartweekly_options.series.push(series)
      dummy = 1;
    }    
    else if (lineNo > 0) {
...
iosloginfunnelstartweekly = new Highcharts.Chart(iosloginfunnelstartweekly_options);
