...
iosclosedloginfunnelmonthly_options = {
  chart: {
    renderTo: 'iosclosedloginfunnelmonthly',
    type: 'area',
    // zoomType: 'x',
    height: 500,
    // width: 1000,
  ...
  title: {
    text: 'iOS Closed Bundle Login Funnel per Month'
  },
  subtitle: {
...
$.get('csv/KPI_Robin_iOSClosedLoginFunnelMonthly.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      iosclosedloginfunnelmonthly_options.series.push(series)
      dummy = 1;
    }
...
iosclosedloginfunnelmonthly = new Highcharts.Chart(iosclosedloginfunnelmonthly_options);
