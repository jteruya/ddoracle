...
iosopenloginfunneldevicesweekly_options = {
  chart: {
    renderTo: 'iosopenloginfunneldevicesweekly',
    type: 'column',
    zoomType: 'x',
    height: 500,
    // width: 1000,
...
$.get('csv/KPI_Robin_iOSOpenLoginFunnelDevicesWeekly.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      iosopenloginfunneldevicesweekly_options.series.push(series)
      dummy = 1;
    }    
    else if (lineNo > 0) {
...
iosopenloginfunneldevicesweekly = new Highcharts.Chart(iosopenloginfunneldevicesweekly_options);
