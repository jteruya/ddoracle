...
iosclosedloginfunneldevicesweekly_options = {
  chart: {
    renderTo: 'iosclosedloginfunneldevicesweekly',
    type: 'column',
    zoomType: 'x',
    height: 500,
    // width: 1000,
...
$.get('csv/KPI_Robin_iOSClosedLoginFunnelDevicesWeekly.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      iosclosedloginfunneldevicesweekly_options.series.push(series)
      dummy = 1;
    }    
    else if (lineNo > 0) {
...
iosclosedloginfunneldevicesweekly = new Highcharts.Chart(iosclosedloginfunneldevicesweekly_options);
