...
androidclosedloginfunnelweekly_options = {
  chart: {
    renderTo: 'androidclosedloginfunnelweekly',
    type: 'area',
    // zoomType: 'x',
    height: 500,
    // width: 1000,
  ...
  title: {
    text: 'Android Closed Bundle Login Funnel per Week'
  },
  subtitle: {
...
$.get('csv/KPI_Robin_AndroidClosedLoginFunnelWeekly.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      androidclosedloginfunnelweekly_options.series.push(series)
      dummy = 1;
    }
...
androidclosedloginfunnelweekly = new Highcharts.Chart(androidclosedloginfunnelweekly_options);
