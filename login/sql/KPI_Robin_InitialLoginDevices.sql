select time_spine.bundle_type as "type"
     , time_spine.date as "YYYYMM"
     , count(*) as "cnt"
/*
...
from (select calendar.date
      ...
      join (select 'mixed' as bundle_type
            union
            select 'closed' as bundle_type
            union
            select 'open' as bundle_type) bundle_type
      on 1 = 1
