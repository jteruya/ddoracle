...
# Generate JS Using JSON Data 
python $domain_wd/columncharttemplate.py adoption_weeklevel.json Adoption adoption_eventtypelevel.json adoptioncontainer.js "Adoption % Trend" "By Week (Closed Reg US Server Events Only)" "Adoption %" "#7CB5EC"
python $domain_wd/columncharttemplate.py activeusers_weeklevel.json "Active Users" activeusers_eventtypelevel.json activeuserscontainer.js "Active Users Count Trend" "By Week (All US Server Events)" "Active Users Count" "#90ED7D"
python $domain_wd/columncharttemplate.py events_weeklevel.json "Events" events_eventtypelevel.json eventscontainer.js "Event Count Trend" "By Week (All US Server Events)" "Event Count" "#F7A35C"
python $domain_wd/columncharttemplate.py appsessions_weeklevel.json "App Sessions" appsessions_eventtypelevel.json appsessionscontainer.js "App Session Count Trend" "By Week (All US Server Events)" "App Session Count" "#8085E9"
