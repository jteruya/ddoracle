...
eventcount_options = {
  ...
  tooltip: {
    formatter: function () {
    var s = '<b>' + Highcharts.dateFormat('%b %Y', this.x) + '</b>: <br>' + this.series.name + ': ' + this.y + ' Events in this Month';
...
$.get('csv/KPI_Robin_EventCount_pred.csv', function(data) {
...
eventcount = new Highcharts.Chart(eventcount_options);
