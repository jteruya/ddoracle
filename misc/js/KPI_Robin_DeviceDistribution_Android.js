...
devicedistributionandroid_options = {
  chart: {
    renderTo: 'devicedistributionandroid',
    type: 'area',
    // zoomType: 'x',
    height: 500,
    // width: 1000,
...
$.get('csv/KPI_Robin_DeviceDistribution_Android.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      devicedistributionandroid_options.series.push(series)
      dummy = 1;
    }    
    else if (lineNo > 0) {
...
devicedistributionandroid = new Highcharts.Chart(devicedistributionandroid_options);
