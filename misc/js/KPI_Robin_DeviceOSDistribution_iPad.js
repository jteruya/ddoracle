...
deviceosdistributionipad_options = {
  chart: {
    renderTo: 'deviceosdistributionipad',
    type: 'area',
    // zoomType: 'x',
    height: 500,
    // width: 1000,
  ...
  title: {
    text: 'User Device OS (iPad) Distribution - by Month'
  },
  subtitle: {
...
$.get('csv/KPI_Robin_DeviceOSDistribution_iPad.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      deviceosdistributionipad_options.series.push(series)
      dummy = 1;
    }    
    else if (lineNo > 0) {
...
deviceosdistributionipad = new Highcharts.Chart(deviceosdistributionipad_options);
