...
userosdistribution_options = {
  chart: {
    renderTo: 'userosdistribution',
    type: 'area',
    // zoomType: 'x',
    height: 500,
    // width: 1000,
  ...
  title: {
    text: 'User OS Distribution - by Month'
  },
  subtitle: {
...
$.get('csv/KPI_Robin_UserOSDistribution.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      userosdistribution_options.series.push(series)
      dummy = 1;
    }    
    else if (lineNo > 0) {
...
userosdistribution = new Highcharts.Chart(userosdistribution_options);
