...
devicedistributionios_options = {
  chart: {
    renderTo: 'devicedistributionios',
    type: 'area',
    // zoomType: 'x',
    height: 500,
    // width: 1000,
...
$.get('csv/KPI_Robin_DeviceDistribution_iOS.csv', function(data) {
  ...
  $.each(lines, function(lineNo, line) {
    ...
    if (lineNo == linecnt) {
      console.log('End');
      devicedistributionios_options.series.push(series)
      dummy = 1;
    }    
    else if (lineNo > 0) {
...
devicedistributionios = new Highcharts.Chart(devicedistributionios_options);
