...
# Report fields
kpi_chat_event_report="KPI_Chat_Event"
kpi_chat_event_detail_report="KPI_Chat_Event_Detail"
kpi_chat_user_report="KPI_Chat_User"
kpi_chat_user_detail_report="KPI_Chat_User_Detail"
kpi_chat_split_report="KPI_Chat_Split"
...
$run_sql_robin $domain_wd/sql/$kpi_chat_event_report.sql | sed \$d | sed 's/\"//g' > $domain_wd/csv/$kpi_chat_event_report.csv 
$run_sql_robin $domain_wd/sql/$kpi_chat_event_detail_report.sql | sed \$d | sed 's/\"//g' > $domain_wd/csv/$kpi_chat_event_detail_report.csv 
$run_sql_robin $domain_wd/sql/$kpi_chat_user_report.sql | sed \$d | sed 's/\"//g' > $domain_wd/csv/$kpi_chat_user_report.csv 
